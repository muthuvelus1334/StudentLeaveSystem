                    ...
                    <div class="col-12">
                        <div class="card">
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    <!-- <h4 class="header-title">Student Leave History</h4> -->
                                    ...
                                    <select class="custome-select border-0 pr-3">
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.StudentId,tblstudents.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblstudents on tblleaves.studentid=tblstudents.id order by lid desc limit 7";
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="update-student.php?studentid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?></a></td>
