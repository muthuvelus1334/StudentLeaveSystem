                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-student.php" class="btn btn-sm btn-info">Add New Student</a></center>
                                    ...
                                    <?php 
                                    $sql = "SELECT StudentId,FirstName,LastName,Department,Status,RegDate,id from  tblstudents";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    ...
                                    {               ?>  
                                        <tr>
                                            ...
                                            <td><a href="update-student.php?studentid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" style="color:green"></i></a>
