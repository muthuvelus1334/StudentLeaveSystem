                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center">
                                            ...
                                            $sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.StudentId,tblstudents.id,tblstudents.Gender,tblstudents.Phonenumber,tblstudents.StudentId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblstudents on tblleaves.studentid=tblstudents.id where tblleaves.id=:lid";
                                            $query = $dbh -> prepare($sql);
                                            ...
                                            {         
                                              ...
                                              <td colspan="1"><?php echo htmlentities($result->StudentId);?></td>
