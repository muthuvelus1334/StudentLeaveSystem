<?php
    ...
    $sql="INSERT INTO tblstudents(StudentId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:studentid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
...
<head>
    ...
    <script>
        function checkAvailabilityStudentid() {
            $("#loaderIcon").show();
            jQuery.ajax({
            ...
            $("#studentid-availability").html(data);
            $("#loaderIcon").hide();
            },
            error:function (){}
            });
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashboard.php"><img src="../assets/images/icon/Srm University-logo.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="studentcode" type="text" autocomplete="off" required id="studentcode" onBlur="checkAvailabilityStudentid()">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Student Department</label>
