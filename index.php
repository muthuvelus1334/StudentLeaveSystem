<?php
    ...
    if(isset($_POST['signin']))
    {
        ...
        if($query->rowCount() > 0)
        {
            ...
            if($status == 0)
            {
                $msg = "Your account is currently inactive. Please contact your department coordinator or administrator.";
            } else {
                $_SESSION['studentlogin'] = $uname;
                echo "<script type='text/javascript'> document.location = 'students/leave.php'; </script>";
            }
        } else {
            $error = "Sorry, invalid student credentials. Please check your email and password.";
        }
    }
?>
...
<head>
    ...
    <title>Student Portal &bull; Student Leave Management System</title>
...
<body>
    ...
    <div class="portal-container">
        ...
        <!-- Left Section: College Authority & Student Guidance -->
            ...
            <div class="academic-header">
                ...
                <div>
                    <span class="academic-badge">
                        <i class="ti-id-badge"></i> Student Self-Service Portal
                    </span>
                    <h1 class="academic-title">Student Leave Management System</h1>
                    <p class="academic-desc">
                        Official campus portal for enrolled students to apply for academic leave, on-duty approval, view sanction updates, and inspect leave history.
                    </p>
                </div>
            </div>

            <!-- Student Leave Policy Notice -->
            <div>
                <div class="compliance-box">
                    <h6><i class="ti-info-alt"></i> Leave Submission Guidelines</h6>
                    <p>Applications must be submitted with valid justifications. Final approvals are subject to mentor and Department Head review.</p>
                </div>
        ...
        <!-- Right Section: Student Sign In Terminal -->
        <div class="auth-panel">
            <div class="auth-box">
                <div class="auth-header">
                    <h3>Student Sign In</h3>
                    <p>Enter your registered college credentials to access your account.</p>
                </div>

                <!-- Error & Inactive Alerts -->
                <?php if(!empty($error)): ?>
                ...
                <?php if(!empty($msg)): ?>
                    <div class="college-alert-warning" role="alert">
                ...
                <form name="signin" method="POST" autocomplete="off">
                    ...
                    <div class="form-group-official">
                        <label for="username">Registered College Email</label>
                        <div class="official-input-wrapper">
                            <input type="email" id="username" name="username" placeholder="e.g. student@srmist.edu.in" required autofocus>
                    ...
                    <div class="utility-row">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="rememberMe" style="cursor: pointer; color: #475569;">Remember Me</label>
                        </div>
                    ...
                    <button id="form_submit" type="submit" name="signin" class="btn-official-signin">
                        <i class="ti-arrow-right"></i> Log In to Student Portal
                    </button>
                    ...
                    <div class="auth-footer">
                        <div>
                            <a href="admin/index.php">
                                <i class="ti-shield"></i> Faculty &amp; Staff Administration Login
                            </a>
                        </div>
                        <span class="text-muted" style="font-size: 0.78rem;">
                            Need help? Contact your Department Coordinator or Campus IT Helpdesk
                        </span>
                    </div>
